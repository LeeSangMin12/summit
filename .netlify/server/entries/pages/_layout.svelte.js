...
const css$1 = {
  code: "footer.svelte-1hzgsvy.svelte-1hzgsvy{display:flex;flex-direction:column;justify-content:center;align-items:center;padding:12px}footer.svelte-1hzgsvy a.svelte-1hzgsvy{font-weight:bold}@media(min-width: 480px){footer.svelte-1hzgsvy.svelte-1hzgsvy{padding:12px 0}}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<footer class="${"svelte-1hzgsvy"}"><p>visit <a href="${"https://kit.svelte.dev"}" class="${"svelte-1hzgsvy"}">kit.svelte.dev</a> to learn SvelteKit</p>
</footer>`;
});
const styles = "";
